...
export const PrescriptionModal: React.FC<PrescriptionModalProps> = ({
  ...
  const whatsappMessage = `*Receta médica veterinaria — Veterinaria Arlekyn*\n\n` +
    ...
    `${prescriptionText}\n\n` +
    `_Veterinaria Arlekyn — Consulta y tratamiento_`;
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-xs z-50 flex items-center justify-center p-md animate-fade-in overflow-y-auto print:bg-white print:p-8 print:static print:block print:inset-auto print:backdrop-blur-none">
      <div className="relative bg-white rounded-2xl max-w-2xl w-full p-8 shadow-2xl flex flex-col gap-6 border border-slate-200 my-auto text-slate-900 font-body-md print:shadow-none print:border-none print:w-full print:max-w-none print:p-0 print:m-0">
        ...
        {/* Tarjeta imprimible de Receta Médica */}
        <div id="prescription-printable-card" className="flex flex-col gap-6 bg-white p-2 rounded-xl">
          ...
          <div className="flex items-center justify-between border-b-2 border-purple-900/30 pb-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col justify-center">
                <h2 className="font-display-lg text-xl font-bold text-[#1D1426] leading-snug">
                  Veterinaria Arlekyn
                </h2>
          ...
          {/* Ficha Resumen Paciente & Veterinario */}
          ...
          <div className="flex items-end justify-between pt-4 border-t border-slate-200">
            <div className="text-xs text-slate-500 font-medium">
              <p>Documento de prescripción veterinaria generado por Veterinaria Arlekyn.</p>
